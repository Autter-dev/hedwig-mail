  ...
  return (
    <Link
      ...
      className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
        isActive
          ? 'bg-primary/10 text-sidebar-active-foreground'
          : 'text-sidebar-foreground hover:bg-secondary hover:text-foreground'
      }`}
    >
      <span className={isActive ? 'text-sidebar-active' : 'opacity-60'}>
        {item.icon}
      </span>
      {item.label}
    </Link>
      ...
      <div className="border-t border-sidebar-border px-3 py-3 space-y-2">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-sidebar-foreground transition-colors hover:bg-secondary hover:text-foreground"
          >
